...
public class AndroidVideoPlayerControl {
	...
	String mPlayingUrl = "";
	static AndroidVideoPlayerControl mInstance = null;
	...
	AndroidVideoPlayerControl(Context context){
		mContext = context;
	}

	public static AndroidVideoPlayerControl getInstance(Context context){
		if(mInstance == null)
			mInstance = new AndroidVideoPlayerControl(context);
		return mInstance;
	}
	...
	/*	mContext.startActivity(
		new Intent().setComponent(new ComponentName("rainbow.MediaRenderer","rainbow.MediaRenderer.LocalImageView"))
					.setData(Uri.parse(uri.toString()))
					.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK)      
		);*/
	}
