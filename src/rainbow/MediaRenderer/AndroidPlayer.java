...
public class AndroidPlayer {
	...
	String mPlayingUrl = "";
	static AndroidPlayer mInstance = null;
	...
	AndroidPlayer(Context context){
		mContext = context;
	}

	public static AndroidPlayer getInstance(Context context){
		if(mInstance == null)
			mInstance = new AndroidPlayer(context);
		return mInstance;
	}
