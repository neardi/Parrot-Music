...
public class AndroidMusicControler {
	...
	AndroidMusicControler (Context context){
		mContext = context;

	}
	public static AndroidMusicControler getInstance(Context context) {
		
		if(mInstance == null)
			mInstance = new AndroidMusicControler(context);
